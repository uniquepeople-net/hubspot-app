<template>
	<div>
		...
		<Fieldset legend="Pokyny/Guidelines" :toggleable="true" class="fieldset" :collapsed="true">
			<Fieldset v-if="this.survey && this.survey.type_id === 2 && this.survey.advanced.competition_id !== 771" 
					  legend="Hráč sezóny ÚFP / ÚFP Male Player of the Season" :toggleable="true" class="fieldset" :collapsed="true">
			...
			<Fieldset v-if="this.survey && this.survey.type_id === 2 && this.survey.advanced.competition_id === 771" 
					  legend="Hráčka sezóny ÚFP / ÚFP Woman Player of the Season" :toggleable="true" class="fieldset" :collapsed="true">
					<h6>Hráčka sezóny ÚFP / <span class="ital">ÚFP Woman Player of the Season</span></h6>
					<span>2022/2023</span>
					<h6 class="mt-2">Ako hlasovať? / How to vote?</h6>
					<p>Z celkového zoznamu hráčok vyber 3 hráčky, ktoré boli podľa teba najlepšie v najvyššej súťaži
					(1. liga) a zároveň im urči poradie od 1. do 3. miesta. / <span class="ital">From the list of players, you shall select 3
					players who, in your opinion, were the best players in the highest division (1. Liga) and at the
					same time you shall determine their order from 1st to 3rd place.</span></p>
					...
					<p>Ocenenie „Hráčka sezóny ÚFP“ sa udeľuje aktívej hráčke najvyššej seniorskej súťaže žien na
					Slovensku, ktorej individuálne výkony počas celej sezóny ocenili ostatné hráčky ako najlepšie zo
					všetkých. Ocenenie stelesňuje prínos jednotlivkyne pre tím aj celú súťaž a zdôrazňuje jedinečnosť,
					výnimočnosť a príkladnosť jej výkonov, ktoré ju počas sezóny významne odlíšili od výkonov jej
					spoluhráčok a protihráčok. / <span class="ital">The "ÚFP Woman Player of the Season" award is given to an active player of
					the highest senior women's competition in Slovakia, whose individual performance throughout the season
					was rated by other players as the best of all. The award embodies the individual's contribution to the
					team and the competition as a whole and emphasizes the uniqueness, excellence, and exemplary
					performance of the player, which significantly distinguished her from the performance of her
					teammates and opponents during the season.</span></p>
			</Fieldset>

			<Fieldset 	v-if="this.survey && this.survey.type_id === 2 && this.survey.advanced.competition_id !== 771"
						legend="TOP 11 ÚFP (Muži/Men)" :toggleable="true" class="fieldset mt-2" :collapsed="true">
				...
				prescribed number of players for a specific position who, in your opinion, were the best at that position
			...
			<Fieldset 	v-if="this.survey && this.survey.type_id === 2 && this.survey.advanced.competition_id === 771"
						legend="TOP 11 ÚFP (Ženy/Women)" :toggleable="true" class="fieldset mt-2" :collapsed="true">

				<h6>TOP 11 ÚFP (Ženy/Women)</h6>
				<span>2022/2023</span>
				<h6 class="mt-2">Ako hlasovať? / <span class="ital">How to vote?</span></h6>
				<p>Z celkového zoznamu hráčok vyber predpísaný počet hráčok na konkrétny post, ktoré boli podľa teba
				najlepšie na danom poste v najvyššej súťaži (1. liga). /<span class="ital">From the list of players, you shall select the
				prescribed number of players for a specific position who, in your opinion, were the best at that position
				in the highest competition (Fortuna League).</span></p>

				<p>Výberom hráčky na jednotlivom poste určuješ váhu svojich hlasov nasledovne: / <span class="ital">choosing a player
					for an individual position, you determine the value of your votes as follows:</span></p>

				<ul class="no-style">
					<li>1 brankárka/goalie = 1 point</li>
					<li>3 obrankyňe/defenders = 1 point each</li>
					<li>3 záložníčky/midfielders = 1 point each</li>
					<li>3 útočníčky/strikers = 1 point each</li>
				</ul>
					

				<h6>Za koho hlasujem? / <span class="ital">Who am I voting for?</span></h6>

				<p>Ocenenie „TOP 11 ÚFP“ sa udeľuje 11 hráčkam najvyššej seniorskej súťaže žien na Slovensku, ktorých
				individuálne výkony na konkrétnych postoch počas celej sezóny ocenili ostatné hráčky ako najlepšie zo
				všetkých. Ocenenie zdôrazňuje výnimočnosť výkonov a zručnosť hráčky na konkrétnom poste, ktoré ju
				počas sezóny významne odlíšili od výkonov jeho spoluhráčok a protihráčok hrajúcich na rovnakých
				postoch. /<span class="ital"> The "TOP 11 ÚFP" award is given to 11 players of the highest senior women's competition in
				Slovakia, whose individual performances in specific positions throughout the season were recognized
				by other players as the best of all. The award highlights the exceptional performance and skill of a
				player in a specific position, which during the season significantly distinguished her from the
				performances of her teammates and opponents playing in the same positions.</span></p>
			</Fieldset>
		</Fieldset>
