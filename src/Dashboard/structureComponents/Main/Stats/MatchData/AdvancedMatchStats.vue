<template>
	<div>
		...
		<div class="mt-3">
			...
			<MatchStatBar v-for="stat in advStatBars" :title="stat.label" :values="stat.values" :percentage="stat.percentage ? stat.percentage : false"/>
		</div>
	</div>
</template>
...
<script>
	...
	export default {
		...
		computed: { 
			...
			advStatBars() {			
				return [
					{ label: this.$i18n.t("message.BallPossession"), values: { team1: this.stats.possession.team1.possessionPercent, team2: this.stats.possession.team2.possessionPercent }, percentage: true },
					{ label: this.$i18n.t("message.Completedpasses"), values: { team1: this.stats.passes.team1.passes, team2: this.stats.passes.team1.passes } },
					{ label: this.$i18n.t("message.TotalAttempts"), values: { team1: this.stats.general.team1.shots, team2: this.stats.general.team2.shots } },
					{ label: this.$i18n.t("message.Shotsontarget"), values: { team1: this.stats.general.team1.shotsOnTarget, team2: this.stats.general.team2.shotsOnTarget } },
